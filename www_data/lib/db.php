...
function db_insert_compte($db, $nom, $methode, $age, $mail, $mdp, $decouvert, $research) {
	static $sql = "INSERT INTO compte (nom, methode, age, email1, motdepasse, decouvert, research) VALUES (:nom, :methode, :age, :email1, :motdepasse, :decouvert, :research)";
...
function db_update_compte_param_int($db, $param, $value, $no_compte) {
	$param_list = ["methode", "age", "nb_co_echoue", "donateur", "actif", "relance", "timeline_asc", "research"];
	if (!in_array($param, $param_list, true)) return false;
