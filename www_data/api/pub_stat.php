...
db_update_increment_cle_valeur($db, "pub_visite_mensuel");
db_update_increment_cle_valeur($db, "pub_visite_hebdo");
db_update_increment_cle_valeur($db, "pub_visite_jour");
